        ...
        <div className="container px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {ALL_SERVICES.map((service, idx) => (
              <Card key={idx} className="h-full border-border/50 bg-surface/50 backdrop-blur-sm group hover:border-primary/50 hover:bg-surface transition-all duration-300">
                <CardHeader>
